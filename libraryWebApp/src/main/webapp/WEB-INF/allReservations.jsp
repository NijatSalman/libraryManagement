...
<div>
    <table class="table">
        ...
        <c:forEach items="${bookReservObj}" var="value">
            <form:form action="/adminDashboard/admin/dismiss/order" method="POST" modelAttribute="bookReservationForum" >
                <tr>
                    ...
                    <td>
                        ...
                        <form:button class="btn btn-danger" type="submit" id="btnreject">Dismiss</form:button>
                    </td>
            </form:form>
                    <td>
